function [model, da, obs, diags, state] = DA_exps(my_config)
...
% Initialize Model:
[model, x0] = initialize_seir_exps(ti, tl, tv, tf, my_config);
...
% DA Configuration:
[Ol, Y, R, Xa, da] = configure_DA_exps(model, x0, obs.Active, obs.Recovered, obs.Deaths, obs.Vaccinated, my_config);
